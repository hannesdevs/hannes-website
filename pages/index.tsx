...
const ACTIONS: Array<NavigationItem> = [
	...
	},
	{
		type: NavigationItemType.LINK,
		external: true,
		href: 'https://github.com/hannesdevs',
...
export default function HomePage() {
	...
	const birthday = new Date('2009-02-02');
	const age = differenceInYears(today, birthday);
	const isBirthday = isSameDay(today, birthday) && isSameMonth(today, birthday);

	const description = `I am a ${age} year old web- and discord.js-developer. I also do graphic design.`;
			...
			<Container>
				<Content>
					<Transition duration={1000} enabled={animations}>
						<Title>
							Hey <Wave>👋</Wave> I&apos;m Johannes, <LineBreak />a{' '}
